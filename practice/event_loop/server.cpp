...
/*Using uint8_t for wbuf in the Conn structure is
 a practical choice for handling binary data, 
 ensuring each element is exactly one byte. 
 This allows wbuf to store characters and
  other types of data reliably.
*/
...
static int32_t accept_new_connection(vector<Conn*>&fd2conn,int fd)
{
...
static bool try_fill_buffer(Conn *conn)
{
    ...
    // try to process the request one by one
    // pipelining
...
int main(){
    ...
    while(true){
        ...
        // poll for active fds
        // the timeout argument does'nt matter here
